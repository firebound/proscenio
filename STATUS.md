...
Five Type A fixtures auto-walked by `run_tests.py`: [`doll`](examples/doll/), [`blink_eyes`](examples/blink_eyes/), [`shared_atlas`](examples/shared_atlas/), [`simple_psd`](examples/simple_psd/), [`slot_cycle`](examples/slot_cycle/).
