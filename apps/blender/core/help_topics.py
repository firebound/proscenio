...
_DOC_PATHS: dict[str, str] = {
    ...
    # row button inside Pose Mode, so it anchors into that section rather than
    # owning one of its own (Decision 5).
    "skeleton": "skeleton",
    ...
    # subpanel, so it anchors into that section (Decision 5). Its body still
    # needs the copy-rewrite PR to earn a dedicated in-section anchor.
