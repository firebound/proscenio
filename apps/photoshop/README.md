...
Deeper context: [`.ai/skills/photoshop-uxp-dev.md`](../../.ai/skills/photoshop-uxp-dev.md) and [`docs/00-guides/01-advanced/01-photoshop.md`](../../docs/00-guides/01-advanced/01-photoshop.md). Locked stack and migration decisions live in the Photoshop UXP migration entry of [`specs/decisions.md`](../../specs/decisions.md#photoshop-uxp-migration-shipped).
