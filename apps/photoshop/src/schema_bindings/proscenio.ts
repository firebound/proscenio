...
/**
 * [x, y, width, height] as fractions of the atlas size, normalized to [0, 1] (same convention as mesh UVs). Consumers scale by the atlas pixel size - e.g. the Godot Sprite2D builder multiplies region_rect by the texture dimensions.
 *
 * @minItems 4
 * @maxItems 4
 */
