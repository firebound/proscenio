...
Interactive reference for the two wire formats, rendered live from the JSON Schemas that the codegen dumps from the pydantic models in [`packages/models/`](../../packages/models/). Expand a field to see its type and drill into the referenced types.
