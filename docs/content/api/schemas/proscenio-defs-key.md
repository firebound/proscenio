...
| [position](#position)     | Merged   | Optional | cannot be null | [Proscenio character](proscenio-defs-key-properties-position.md "https://space-wizard-studios.github.io/proscenio/schemas/proscenio.schema.json#/$defs/Key/properties/position")     |
| [rotation](#rotation)     | Merged   | Optional | cannot be null | [Proscenio character](proscenio-defs-key-properties-rotation.md "https://space-wizard-studios.github.io/proscenio/schemas/proscenio.schema.json#/$defs/Key/properties/rotation")     |
| [scale](#scale)           | Merged   | Optional | cannot be null | [Proscenio character](proscenio-defs-key-properties-scale.md "https://space-wizard-studios.github.io/proscenio/schemas/proscenio.schema.json#/$defs/Key/properties/scale")           |
