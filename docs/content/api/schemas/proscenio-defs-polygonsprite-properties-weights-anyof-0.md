# Untitled array in Proscenio character Schema

```txt
https://space-wizard-studios.github.io/proscenio/schemas/proscenio.schema.json#/$defs/PolygonSprite/properties/weights/anyOf/0
```
