...
|-- 02_photoshop_setup/     [AUTHORED] artist workbench: real-character PSD (doll_tagged.psd) + tag-taxonomy oracle (debug/doll_tagged_debug.psd) + re-exported manifest
...
[01_photoshop_base/]      doll_ps_base.psd
        ...
        v
[02_photoshop_setup/]     doll_tagged.psd (real)  +  debug/doll_tagged_debug.psd (tag oracle)
        |   (Proscenio Exporter panel: Export manifest + PNGs)
        v
    doll_tagged.photoshop_exported.json (real)  +  debug/doll_tagged_debug.photoshop_exported.json (oracle)
        |
        v
...
| 02 | `02_photoshop_setup/` | `doll_tagged.psd` (real character) + `debug/doll_tagged_debug.psd` (tag oracle) + re-exported manifest | yes |
