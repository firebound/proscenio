...
A reconciliação de 2026-06-11 removeu os itens já trabalhados (resolvidos saíram; adiados / gated / dropados foram pro [`deferred.md`](deferred.md), [`gated.md`](gated.md), [`dropped.md`](dropped.md)). O que resta aqui é polish de UI/help surfaces ainda não atacado.
