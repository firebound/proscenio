...
defaults. Não são bugs (não vão para `backlog-bugs-found.md`), são
...
2026-06-16: os três grupos que restavam aqui (Element panel, Outliner panel, Materials panel proposal) foram promovidos para [`backlog.md`](backlog.md#fila-da-sprint). O arquivo segue vivo como bucket de novo polish de UI/help surfaces que aparecer.
